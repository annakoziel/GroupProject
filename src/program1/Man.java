...
public class Man extends User implements BMIProduct{
    ...
    public void BMIProduct() {
        bmi=calculateBMI();
        if (bmi<17)
            wynik="Wychudzenie to groźny dla zdowia stan. W przypadku BMI wskazującego na wychudzenie "
            ...
            wynik="Masz niedowagę. Musisz wiedzieć o tym, że bardzo niska masa ciała wiąże się z występowaniem "
            ...
            wynik="Masz idealną masę ciała. Jednak, aby Twoje BMI nadal "
            ...
            wynik=" Nadwaga. To jest najwyższy czas, aby zmienić swój sposób odżywiania, głównie ograniczyć "
            ...
            System.out.println("Otyłość I stopnia. Wraz ze wzrostem masy ciała rośnie ryzyko niedokrwiennej choroby serca, "
            ...
            wynik="Otyłość II stopnia. Niewątpliwie duże jest ryzyko wystąpienia chorób wynikających z "
            ...
            wynik="III stopień otyłości.  W takiej sytuacji zgłoś się do odpowiedniego specjalisty, "
